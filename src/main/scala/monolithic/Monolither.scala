...
/**
  ...
  * @param HLE
  */
class Monolither(DB: Database, delta: Double, breakTiesThreshold: Double,postPruningThreshold: Double,
                  ...
                  HLE: String, handCraftedTheoryFile: String="", globals: Globals) extends Actor with LazyLogging{
    ...
    case "EvaluateHandCrafted" =>
      for (dataset <- trainingData) {
        ...
        context.actorOf(Props(
          new MonDispatcher(DB,delta,breakTiesThreshold,postPruningThreshold,minSeenExmpls,
