...
class MonDispatcher(val DB: Database, val delta: Double, val breakTiesThreshold: Double, val postPruningThreshold: Double, val minSeenExmpls: Double,
  ...
  def receive = {
    ...
    case "start" =>
      ...
      context.actorOf(Props(
        new MonTheoryLearner(DB, delta, breakTiesThreshold, postPruningThreshold,
