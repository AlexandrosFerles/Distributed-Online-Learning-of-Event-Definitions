...
*/
  ...
  val meetTrainingSet21 = {
    val training = List(meetPos2,meetPos3,meetPos4,meetPos5) ++ List(meetNeg4,meetNeg5,meetNeg6,meetNeg7,
  ...
  val  meetTrainingSet22 = {
    val training = List(meetPos6,meetPos7,meetPos8,meetPos9,meetPos10) ++ List(meetNeg17,meetNeg18,meetNeg19,meetNeg20,meetNeg21,meetNeg22,meetNeg23,
  ...
  val meetTrainingSet41 = {
    val training =     List(Interval("meeting",27280,31520), Interval("meeting",40120,44360), Interval("meeting",261520,301480), Interval("meeting",101520,141480), Interval("meeting",341520,381480), Interval("meeting",35840,40080), Interval("meeting",141520,181480), Interval("meeting",31560,35800), Interval("meeting",181520,221480), Interval("meeting",301520,341480), Interval("meeting",221520,261480))
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet = training, testingSet = testing)
  }

  val meetTrainingSet42 = {
    val training =     List(Interval("meeting",44400,48640), Interval("meeting",52960,57240), Interval("meeting",48680,52920), Interval("meeting",421520,461480), Interval("meeting",509760,559240), Interval("meeting",461520,501480), Interval("meeting",564160,604120), Interval("meeting",604160,644120), Interval("meeting",381520,421480), Interval("meeting",57280,61560), Interval("meeting",501520,507160))
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet = training, testingSet = testing)
  }

  val meetTrainingSet43 = {
    val training =    List(Interval("meeting",507120,509800), Interval("meeting",684160,724120), Interval("meeting",764160,785240), Interval("meeting",724160,764120), Interval("meeting",644160,684120), Interval("meeting",785240,786320), Interval("meeting",835480,842720), Interval("meeting",814920,829440), Interval("meeting",786280,813120), Interval("meeting",559200,564200), Interval("meeting",813080,814960))
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet = training, testingSet = testing)
  }

  val meetTrainingSet44 = {
    val training =    List(Interval("meeting",829400,835520), Interval("meeting",842680,843640), Interval("meeting",934880,954840), Interval("meeting",954880,974840), Interval("meeting",974880,994840), Interval("meeting",892440,894920), Interval("meeting",894880,914840), Interval("meeting",914880,934840), Interval("meeting",1005840,1009040), Interval("meeting",1009000,1009880), Interval("meeting",843600,892480), Interval("meeting",994880,1005760))
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet = training, testingSet = testing)
  }
  //----------------------------------
  ...
  val meetTrainingSet61 = {
    val training =  List(Interval("meeting",27280,31520), Interval("meeting",101520,141480), Interval("meeting",141520,181480), Interval("meeting",221520,261480), Interval("meeting",181520,221480), Interval("meeting",31560,35800))
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet =training, testingSet = testing)
  }

  val meetTrainingSet62 = {
    val training =    List(Interval("meeting",35840,40080), Interval("meeting",301520,341480), Interval("meeting",381520,421480), Interval("meeting",341520,381480), Interval("meeting",40120,44360), Interval("meeting",421520,461480), Interval("meeting",261520,301480))
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet =training, testingSet = testing)
  }

  val meetTrainingSet63 = {
    val training =    List(Interval("meeting",44400,48640), Interval("meeting",604160,644120), Interval("meeting",564160,604120), Interval("meeting",501520,507160), Interval("meeting",48680,52920), Interval("meeting",509760,559240), Interval("meeting",461520,501480), Interval("meeting",52960,57240))
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet =training, testingSet = testing)
  }

  val meetTrainingSet64 = {
    val training  =   List(Interval("meeting",57280,61560), Interval("meeting",644160,684120), Interval("meeting",507120,509800), Interval("meeting",559200,564200), Interval("meeting",724160,764120), Interval("meeting",684160,724120), Interval("meeting",786280,813120), Interval("meeting",764160,785240))
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet =training, testingSet = testing)
  }

  val meetTrainingSet65 = {
    val training =     List(Interval("meeting",785240,786320), Interval("meeting",835480,842720), Interval("meeting",894880,914840), Interval("meeting",914880,934840), Interval("meeting",813080,814960), Interval("meeting",829400,835520), Interval("meeting",843600,892480), Interval("meeting",814920,829440))
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet =training, testingSet = testing)
  }

  val meetTrainingSet66 = {
    val training =    List(Interval("meeting",842680,843640), Interval("meeting",892440,894920), Interval("meeting",1005840,1009040), Interval("meeting",954880,974840), Interval("meeting",934880,954840), Interval("meeting",994880,1005760), Interval("meeting",1009000,1009880), Interval("meeting",974880,994840))
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet =training, testingSet = testing)
  }
  ...
  val meetTrainingSet81 = {
    val training = List(meetPos2) ++ List(meetNeg5, meetNeg4)
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet = training, testingSet = testing)
  }

  val meetTrainingSet82 = {
    val training = List(meetPos3) ++ List(meetNeg7,meetNeg6,meetNeg8)
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet = training, testingSet = testing)
  }

  val meetTrainingSet83 = {
    val training = List(meetPos4) ++ List(meetNeg10,meetNeg9)
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet = training, testingSet = testing)
  }
  ...
  val meetTrainingSet85 = {
    val training = List(meetPos6) ++ List(meetNeg15,meetNeg17,meetNeg18)
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet = training, testingSet = testing)
  }
  ...
  val meetTrainingSet87 = {
    val training = List(meetPos9) ++ List(meetNeg25,meetNeg21,meetNeg23,meetNeg22,meetNeg20,meetNeg24)
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet = training, testingSet = testing)
  }

  val meetTrainingSet88 = {
    val training = List(meetPos8) ++ List(meetNeg28,meetNeg31,meetNeg27) ++ List(meetPos10) ++ List(meetNeg29,meetNeg32,meetNeg26,meetNeg30)
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet = training, testingSet = testing)
  }
  //----------------------------------
