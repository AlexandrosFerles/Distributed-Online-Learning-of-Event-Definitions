...
*/
  ...
  val meetTrainingSet21 = {
    val training = List(meetPos2,meetPos5,meetPos8,meetPos10) ++ List(meetNeg4,meetNeg5,meetNeg6,meetNeg1,
      meetNeg2,meetNeg3,meetNeg10,meetNeg11,meetNeg12,meetNeg13,meetNeg14,meetNeg15,meetNeg16,meetNeg17)
  ...
  val  meetTrainingSet22 = {
    val training = List(meetPos1,meetPos4,meetPos6,meetPos7,meetPos9) ++ List(meetNeg18,meetNeg19,meetNeg20,
      meetNeg21,meetNeg22,meetNeg23, meetNeg24,meetNeg25,meetNeg26,meetNeg27,
      meetNeg28,meetNeg2,meetNeg29,meetNeg30,meetNeg31,meetNeg32)
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }
  ...
  val meetTrainingSet41 = {
    val training = List(meetPos2,meetPos10) ++ List(meetNeg3,meetNeg5,meetNeg6,meetNeg4,
      meetNeg14)
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }
  ...
  val meetTrainingSet42 = {
    val training = List(meetPos1,meetPos8) ++ List(meetNeg15,meetNeg16,meetNeg11,meetNeg12,meetNeg13,meetNeg14)
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val meetTrainingSet43 = {
    val training = List(meetPos7,meetPos5) ++ List(meetNeg20,meetNeg21,meetNeg17,meetNeg18,
      meetNeg19,meetNeg23,meetNeg24,meetNeg22)
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val meetTrainingSet44 = {
    val training = List(meetPos4,meetPos6,meetPos9) ++ List(meetNeg25,meetNeg26,meetNeg27,meetNeg28
      ,meetNeg29,meetNeg30,meetNeg31,meetNeg32,meetNeg33)
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }
  //----------------------------------
