...
object MovingTrainingData10 {
  ...
  */
  ...
  val moveTrainingSet21 = {
    val training = List(movePos2,movePos3,movePos4,movePos5) ++ List(moveNeg2,moveNeg3,moveNeg4,
      moveNeg5,moveNeg6,moveNeg7,moveNeg8,moveNeg9,moveNeg10,moveNeg11,moveNeg12,moveNeg13,moveNeg14,moveNeg15,moveNeg16
      ,moveNeg17,moveNeg18)
  ...
  val moveTrainingSet22 = {
    val training = List(movePos6,movePos7,movePos8,movePos9,movePos10) ++ List(moveNeg19,moveNeg20,moveNeg21,
      moveNeg22,moveNeg23,moveNeg24,moveNeg25,moveNeg26,moveNeg27,moveNeg28,moveNeg29,moveNeg30,moveNeg31,moveNeg32,moveNeg33)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }
  ...
  val moveTrainingSet41 = {
    val training = List(movePos2,movePos3) ++ List(moveNeg2,moveNeg3,moveNeg4,
      moveNeg5,moveNeg6,moveNeg7,moveNeg8,moveNeg9,moveNeg10,moveNeg11,moveNeg12,moveNeg13,moveNeg14)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet42 = {
    val training = List(movePos4,movePos5) ++ List(moveNeg15,moveNeg16
      ,moveNeg17,moveNeg18,moveNeg19)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet43 = {
    val training = List(movePos6,movePos7,movePos8,movePos9) ++ List(moveNeg20,moveNeg21,
      moveNeg22,moveNeg23,moveNeg24,moveNeg25,moveNeg26,moveNeg27)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet44 = {
    val training = List(movePos10) ++ List(moveNeg28,moveNeg29,moveNeg30,moveNeg31,moveNeg32,moveNeg33)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }
  //----------------------------------
  ...
  val moveTrainingSet62 = {
    val training = List(movePos4) ++ List(moveNeg15,moveNeg16,moveNeg17)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet63 = {
    val training = List(movePos5,movePos6) ++ List(moveNeg18,moveNeg19,moveNeg20,moveNeg21,moveNeg22,moveNeg23,moveNeg24)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet64 = {
    val training = List(movePos7,movePos8) ++ List(moveNeg25,moveNeg26)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet65 = {
    val training = List(movePos9) ++ List(moveNeg27)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }
  ...
  val moveTrainingSet81 = {
    val training = List(movePos2) ++ List(moveNeg2,moveNeg3,moveNeg4,moveNeg5,moveNeg6,moveNeg7,moveNeg8)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet82 = {
    val training = List(movePos3) ++ List(moveNeg9,moveNeg10,moveNeg11,moveNeg12,moveNeg13,moveNeg14)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet83 = {
    val training = List(movePos4,movePos5) ++ List(moveNeg15,moveNeg16,moveNeg17,moveNeg18,moveNeg19)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet84 = {
    val training = List(movePos6) ++ List(moveNeg20,moveNeg21,moveNeg22,moveNeg23,moveNeg24)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet85 = {
    val training = List(movePos7) ++ List(moveNeg25)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet86 = {
    val training = List(movePos8) ++ List(moveNeg26)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }
  ...
  val moveTrainingSet1001= {
    val training = List(movePos8) ++ List(moveNeg25,moveNeg26)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }
  ...
  val moveTrainingSet1005= {
    val training = List(movePos5) ++ List(moveNeg18,moveNeg19,moveNeg20)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet1006= {
    val training = List(movePos6) ++ List(moveNeg21,moveNeg22,moveNeg23,moveNeg24)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet1007= {
    val training = List(movePos7) ++ List(moveNeg24,moveNeg25)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }
  ...
  val moveTrainingSet1009= {
    val training = List(movePos9) ++ List(moveNeg26,moveNeg27)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }
  ...
  val moveTrainingSet1211= {
    val training = List(movePos6,movePos7) ++ List(moveNeg23,moveNeg24,moveNeg25)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }
