...
object MovingTrainingData1 {
  ...
  */
  ...
  //----------------------------------
  val moveTrainingSet21 = {
    val training = List(movePos2,movePos4,movePos5,movePos6,movePos9) ++ List(
      moveNeg4, moveNeg5,moveNeg6,moveNeg7,moveNeg8,moveNeg9,moveNeg10,moveNeg11,
      moveNeg12,moveNeg13,moveNeg14,moveNeg23)
  ...
  val moveTrainingSet22 = {
    val training = List(movePos3,movePos7,movePos8,movePos10) ++ List(moveNeg15,moveNeg16
      ,moveNeg17,moveNeg18,moveNeg19,moveNeg20,moveNeg21, moveNeg22,moveNeg24,moveNeg25,moveNeg26,
      moveNeg27,moveNeg28,moveNeg29,moveNeg30,moveNeg32,moveNeg33)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  //----------------------------------
  val moveTrainingSet41 = {
    val training = List(movePos3,movePos4) ++ List(moveNeg4,
      moveNeg5,moveNeg6,moveNeg7,moveNeg8,moveNeg13)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet42 = {
    val training = List(movePos2,movePos6,movePos9) ++ List(moveNeg9,moveNeg10,moveNeg11,moveNeg12,
      moveNeg14,moveNeg16,moveNeg17,moveNeg23)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet43 = {
    val training = List(movePos5,movePos8) ++ List(moveNeg15,moveNeg18,moveNeg19,moveNeg20,moveNeg21,
      moveNeg22)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet44 = {
    val training = List(movePos7,movePos10) ++ List(moveNeg24,moveNeg25,moveNeg26,moveNeg27,moveNeg28,moveNeg29,moveNeg30,moveNeg32,moveNeg33)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }
  //----------------------------------
  val moveTrainingSet61 = {
    val training = List(movePos2,movePos3,movePos7) ++ List(moveNeg7,moveNeg8,moveNeg9,moveNeg16,moveNeg17,moveNeg23,moveNeg24)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet62 = {
    val training = List(movePos4) ++ List(moveNeg4,
      moveNeg5,moveNeg6,moveNeg13)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet63 = {
    val training = List(movePos5,movePos6) ++ List(moveNeg10,moveNeg11,moveNeg12,moveNeg14)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet64 = {
    val training = List(movePos8) ++ List(moveNeg15,moveNeg18,moveNeg19,moveNeg20)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet65 = {
    val training = List(movePos10) ++ List(moveNeg21,moveNeg22,moveNeg27,moveNeg25,moveNeg26)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet66 = {
    val training = List(movePos9) ++ List(moveNeg29,moveNeg30,moveNeg32,moveNeg33)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  //----------------------------------
  val moveTrainingSet81 = {
    val training = List(movePos2,movePos5) ++ List(moveNeg4,moveNeg5,moveNeg6)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet82 = {
    val training = List(movePos3) ++ List(moveNeg7,moveNeg8,moveNeg9)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet83 = {
    val training = List(movePos4) ++ List(moveNeg22,moveNeg29,moveNeg30)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet84 = {
    val training = List(movePos6) ++ List(moveNeg14,moveNeg15,moveNeg18)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet85 = {
    val training = List(movePos7) ++ List(moveNeg10,moveNeg11,moveNeg12)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet86 = {
    val training = List(movePos8) ++ List(moveNeg32,moveNeg33)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet87 = {
    val training = List(movePos9) ++ List(moveNeg19,moveNeg20,moveNeg21)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet88 = {
    val training = List(movePos10) ++ List(moveNeg13,moveNeg16,moveNeg17,moveNeg23,moveNeg24,
      moveNeg25,moveNeg26,moveNeg27,moveNeg28)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }
  //----------------------------------
  val moveTrainingSet1001= {
    val training = List(movePos2) ++ List(moveNeg29,moveNeg30)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet1002= {
    val training = List(movePos3) ++ List(moveNeg22,moveNeg23,moveNeg24,moveNeg25,moveNeg26,moveNeg27,moveNeg28)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet1003= {
    val training = List(movePos4) ++ List(moveNeg4,moveNeg5)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet1004= {
    val training = List(movePos8) ++ List(moveNeg15,moveNeg16,moveNeg17,moveNeg18)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet1005= {
    val training = List(movePos5) ++ List(moveNeg21,moveNeg19,moveNeg20)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet1006= {
    val training = List(movePos6) ++ List(moveNeg6,moveNeg7)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet1007= {
    val training = List(movePos7) ++ List(moveNeg32,moveNeg33)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet1008= {
    val training = List(movePos8) ++ List(moveNeg8,moveNeg9)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet1009= {
    val training = List(movePos9) ++ List(moveNeg10,moveNeg1)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet1010= {
    val training = List(movePos10) ++ List(moveNeg12,moveNeg13,moveNeg14)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }
  //----------------------------------
  val moveTrainingSet1201= {
    val training = List(movePos2) ++ List(moveNeg4,moveNeg5)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet1202= {
    val training = List(movePos3) ++ List(moveNeg6,moveNeg7)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet1203= {
    val training = List(movePos4) ++ List(moveNeg8,moveNeg9)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet1204= {
    val training = List(movePos5) ++ List(moveNeg10,moveNeg11)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet1205= {
    val training = List(movePos6) ++ List(moveNeg12,moveNeg13)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet1206= {
    val training = List(movePos7) ++ List(moveNeg14,moveNeg15)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet1207= {
    val training = List(movePos8) ++ List(moveNeg16,moveNeg17)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet1208= {
    val training = List(movePos9) ++ List(moveNeg18,moveNeg19)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet1209= {
    val training = List(movePos10) ++ List(moveNeg20,moveNeg21)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet1210= {
    val training = List(movePos4) ++ List(moveNeg22,moveNeg23,moveNeg24,moveNeg25,moveNeg26,moveNeg27,moveNeg28)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet1211= {
    val training = List(movePos8) ++ List(moveNeg29,moveNeg30)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val moveTrainingSet1212= {
    val training = List(movePos10) ++ List(moveNeg32,moveNeg33)
    val testing = List(movePos1,movePos11) ++ testingNeg1
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }
  //----------------------------------
