...
*/
  ...
  val meetTrainingSet41 = {
    val training = List(meetPos2,meetPos10) ++ List(meetNeg4,meetNeg5,meetNeg6,meetNeg7,
      meetNeg8)
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }
  ...
  val meetTrainingSet43 = {
    val training = List(meetPos7,meetPos9) ++ List(meetNeg15,meetNeg16,meetNeg17,meetNeg18,meetNeg19,meetNeg23,meetNeg24)
    val testing = List(meetPos1) ++ List(meetNeg1,meetNeg2,meetNeg3,meetNeg33)
    new DataAsIntervals(trainingSet = List(training.head) ++ Random.shuffle(training.tail), testingSet = testing)
  }

  val meetTrainingSet44 = {
    val training = List(meetPos5,meetPos6,meetPos8) ++ List(meetNeg20,meetNeg21,
